...
class TodoItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post :create, todo_item: { activity: @todo_item.activity, descrption: @todo_item.descrption, status: @todo_item.status }
    end
  ...
  test "should update todo_item" do
    patch :update, id: @todo_item, todo_item: { activity: @todo_item.activity, descrption: @todo_item.descrption, status: @todo_item.status }
    assert_redirected_to todo_item_path(assigns(:todo_item))
  end
